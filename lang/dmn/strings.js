_.setTranslation({
	...
	"learned to throw punches with purpose": "习得浑元形意太极拳",
	"martial artist": "马保国老师",
	"punches do even more damage.": "闪电五连鞭",
	"learned to fight quite effectively without weapons": "学会了咏春拳",
	"unarmed master": "叶师傅",
	...
	"learned to make the most of food": "吃嘛嘛香",
	"get the app.": "应用商店",
	"lights off.": "夜间模式",
	"hyper.": "加速",
	"restart.": "重启",
	...
	"lights on.": "开灯",
	"Go Hyper?": "冲冲冲？",
	"turning hyper mode speeds up the game to x2 speed. do you want to do that?": "开冲冲冲，游戏速度变为原有的2倍？",
	"classic.": "原速",
	"{0} per {1}s": "{0} /{1}秒",
	"pause.": "确认",
	"eat meat": "吃肉",
	...
	"take": "带走",
	"take:": "获得:",
	"nothing to take": "笑死，啥也没有",
	"all": "所有",
	"take everything": "三光",
	"take all you can": "拿，都可以拿",
	" and ": "以及",
	"*** EVENT ***": "*** 哎，看我 ***",
	"saved.": "已保存",
	"wood": "木头",
	...
	"more traps won't help now": "再增加陷阱也没啥用了",
	"cart": "货车",
